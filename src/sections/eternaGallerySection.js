...
const ExternaGallerySetion = () => {

    const data = useStaticQuery(graphql`
    query externagalerry {
        allFile(filter: {relativeDirectory: {eq: "externa"}}) {
            edges {
                node {
                  childImageSharp {
                    fluid(quality: 90) {
  ...
  function targetRowHeight(containerWidth) {
    ...
    return (
        <Section id="bar" noPaddingBottom noMarginTopOnMobile noMarginTopOnDesktop>
...
export default ExternaGallerySetion